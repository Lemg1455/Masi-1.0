...
public class MagicGroups {
    ...
    public static void registryMagicGroups(){
        List<Item> items = Arrays.asList(ModItems.FIRE_BALL_MAGIC,ModItems.CREATING_WATER_MAGIC,ModItems.HEAL_MAGIC,ModItems.LIGHTNING_MAGIC,ModItems.GAIN_CIRCLE_MAGIC,ModItems.LOSE_CIRCLE_MAGIC,ModItems.COLD_DISASTER_MAGIC,ModItems.PURIFICATION_MAGIC,ModItems.ELEMENT_AGGREGATION_MAGIC,ModItems.ELEMENTAL_BLESSING_MAGIC,ModItems.BLOCK_PUT_MAGIC,ModItems.BLOCK_HIDDEN_MAGIC,ModItems.UNDEAD_SUMMON_MAGIC,ModItems.METEORITE_MAGIC,ModItems.SPREAD_FIRE_MAGIC);
        addMagicGroup(items,Text.translatable("magicGroup.elemental"),0,0,ModItems.FIRE_BALL_MAGIC.getDefaultStack());

        items = Arrays.asList(ModItems.ARCANE_SHIELD_MAGIC, ModItems.ARCANE_MISSILE_MAGIC,ModItems.ARCANE_TORRENT_MAGIC,ModItems.ARCANE_MINION_MAGIC,ModItems.ARCANE_TENTACLES_MAGIC,ModItems.ARCANE_SWORD_MAGIC,ModItems.ARCANE_BOW_MAGIC);
        addMagicGroup(items,Text.translatable("magicGroup.arcane"),0,1,ModItems.ARCANE_MISSILE_MAGIC.getDefaultStack());

        items = Arrays.asList(ModItems.FLICKER_MAGIC,ModItems.FLY_MAGIC,ModItems.DIMENSION_EXILE_MAGIC,ModItems.IMPRISON_MAGIC,ModItems.INGESTION_MAGIC,ModItems.SHADOW_MANE_MAGIC,ModItems.STEALTH_MAGIC,ModItems.SPACE_PACK_MAGIC,ModItems.TELEPORT_MAGIC);
        addMagicGroup(items,Text.translatable("magicGroup.space"),0,2,ModItems.FLICKER_MAGIC.getDefaultStack());

        items = Arrays.asList(ModItems.RANDOM_MAGIC,ModItems.TAUNT_MAGIC,ModItems.STEAL_MAGIC,ModItems.DEATH_DECLARATION_MAGIC,ModItems.REVENGE_MAGIC,ModItems.INHERIT_TOOL_MAGIC,ModItems.SWORD_MAN_SUMMON_MAGIC);

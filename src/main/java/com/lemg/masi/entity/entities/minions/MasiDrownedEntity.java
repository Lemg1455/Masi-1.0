...
public class MasiDrownedEntity extends DrownedEntity implements Minion{
    @Nullable
    private UUID ownerUuid;
    private LivingEntity owner;

    public MasiDrownedEntity(EntityType<? extends DrownedEntity> entityType, World world) {

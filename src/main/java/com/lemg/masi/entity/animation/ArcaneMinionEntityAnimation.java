...
public class ArcaneMinionEntityAnimation {
    public static final Animation idle = Animation.Builder.create(1.0F).looping()
            .addBoneAnimation("minion", new Transformation(Transformation.Targets.TRANSLATE,
            ...
            .addBoneAnimation("minion", new Transformation(Transformation.Targets.SCALE,
        ...
        public static final Animation attack = Animation.Builder.create(5.0F)
                .addBoneAnimation("left_arm", new Transformation(Transformation.Targets.ROTATE,
                        new Keyframe(0.0F, AnimationHelper.createRotationalVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.LINEAR),
                        new Keyframe(1.0F, AnimationHelper.createRotationalVector(-147.6006F, 14.0285F, -20.9057F), Transformation.Interpolations.LINEAR)
                ))
                ...
                .addBoneAnimation("right_arm", new Transformation(Transformation.Targets.ROTATE,
                        new Keyframe(0.0F, AnimationHelper.createRotationalVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.LINEAR),
                        new Keyframe(1.0F, AnimationHelper.createRotationalVector(-137.0886F, -18.8294F, 12.5471F), Transformation.Interpolations.LINEAR)
                ))
                ...
                .build();
    public static final Animation walk = Animation.Builder.create(0.0417F).looping()
            .addBoneAnimation("left_arm", new Transformation(Transformation.Targets.ROTATE,

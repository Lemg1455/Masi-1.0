...
public class MinionRevengeGoal
    ...
    public MinionRevengeGoal(PathAwareEntity mob, Class<?> ... noRevengeTypes) {
        super(mob, true);
    ...
    public MinionRevengeGoal setGroupRevenge(Class<?> ... noHelpTypes) {
